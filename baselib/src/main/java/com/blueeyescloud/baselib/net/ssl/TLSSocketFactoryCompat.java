...
/**
 * 自定义SSLSocketFactory接受所有证书，域名，且支持TLS1.1，TLS1.2
 * Created by caill on 2016/9/5.
 */
public class TLSSocketFactoryCompat extends SSLSocketFactory {
    ...
    public TLSSocketFactoryCompat() throws KeyManagementException, NoSuchAlgorithmException {
        ...
        context.init(null, new TrustManager[]{new MyTrustManager()}, new java.security.SecureRandom());
...
//                LogUtil.d("tag", "protocolArray[" + i + "]" + protocolArray[i]);
//            }
